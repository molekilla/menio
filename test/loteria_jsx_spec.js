...
var MenioComponent = require('../lib/jsxMenio').MenioComponent;
var MenioElementFactory = require('../lib/jsxMenio').MenioElementFactory;
...
describe("Loteria spec", function () {
    it("when html is requested, should return a model", function () {
        ...
        var Test = (function (_super) {
            ...
            // BORDER="1" CELLSPACING="2" BORDERCOLOR="#008000" CELLPADDING="4"
            Test.prototype.render = function () {
                return MenioElementFactory.createEl('tr', { bgcolor: false }, [
                    MenioElementFactory.createEl('td', null,[{ html: true }])
                ]);
            };
            return Test;
        } (MenioComponent));
